...
from .Modality import DATA_MODALITIES, DataModality
from .bidspathlib_exceptions import *

data_dir: Text = os.path.join(os.path.dirname(__file__), 'json_docs')
data_file: Text = os.path.join(data_dir, 'BIDS_RECOMMENDED.json')
...
BIDS_RECOMMENDED: Dict = json.loads(Path(data_file).read_text())
