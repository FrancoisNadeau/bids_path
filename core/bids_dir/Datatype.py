...
from bids_path.constants.BIDSPathConstants import DATATYPES_DESCRIPTION
...
class Datatype(BIDSDirAbstract):
    ...
    def __init__(self, src: Union[Text, PathLike], **kwargs):
        ...
        _spec: Dict = DATATYPES_DESCRIPTION[self.datatype]
        self.__set_from_dict__(dict(description=_spec['description'],
                                    long_name=_spec['long_name'],
                                    specific=_spec))
